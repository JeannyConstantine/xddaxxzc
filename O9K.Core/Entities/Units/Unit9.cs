namespace O9K.Core.Entities.Units
{
    ...
    public class Unit9 : Entity9
    {
            ...
            : base(baseUnit)
        {
            ...
            this.CreateTime = this.LastVisibleTime = this.LastPositionUpdateTime = GameManager.RawGameTime;
        }
        ...
        public void ChangeBasePosition(Vector3 position)
        {
            ...
            this.LastPositionUpdateTime = GameManager.RawGameTime;
        ...
        internal virtual float GetAttackSpeed(Unit9 target = null)
        {
            ...
            return Math.Max(Math.Min(this.BaseUnit.AttackSpeed + bonusAttackSpeed, GameData.MaxAttackSpeed), GameData.MinAttackSpeed);
        }
